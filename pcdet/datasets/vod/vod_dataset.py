...
class VodDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None):
        ...
        self.sim_info_path_list = [
            Path('/home/a759/data/fog_vod/lidar/training/_CVL_beta_0.030'),
            Path('/home/a759/data/fog_vod/lidar/training/_CVL_beta_0.060/'),
            Path('/home/a759/data/fog_vod/lidar/training/_CVL_beta_0.100/'),
            Path('/home/a759/data/fog_vod/lidar/training/_CVL_beta_0.200/'),
        ]
        self.sim_info_path = Path('/home/a759/data/fog_vod/lidar/training/_CVL_beta_0.030')
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_vod_infos':
        ...
        create_vod_infos(
            ...
            data_path= Path('/home/a759/data/View-of-Delft-Dataset/rlfusion_5f/'),
            save_path= Path('/home/a759/data/View-of-Delft-Dataset/')
        )
